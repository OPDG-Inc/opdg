...
@router.message(~IsVideoUploaded(), Command(commands=["upload_video"]))
@router.message(~IsVideoUploaded(), F.text == "Загрузка видео")
...
@router.message(F.video, ~IsVideoUploaded())
